...
# if always Cannot open video file, may because installed OpenCV not compile with ffmpeg
#   refer to https://docs.opencv.org/trunk/d7/d9f/tutorial_linux_install.html to compile a new opencv

if __name__ == '__main__':
  # Required flags for input and output.
  flags.DEFINE_string('output_tfrecords_file', '/home/dennis/github.com/dennischang/youtube-8m/youtube-8m-output/',
                      'File containing tfrecords will be written at this path.')
  flags.DEFINE_string('input_videos_csv', '/home/dennis/github.com/dennischang/youtube-8m/youtube-8m-raw/input_videos.csv',
  ...
  # Optional flags.
  flags.DEFINE_string('model_dir', '/home/dennis/github.com/dennischang/youtube-8m-models/',
