...
if __name__ == '__main__':
    ...
    flags.DEFINE_string('output_tfrecords_file', './youtube-8m-output/testa0.tfrecord',
                        'File containing tfrecords will be written at this path.')
    flags.DEFINE_string('input_videos_csv',
                        './youtube-8m-raw/input_videos.csv',
    ...
    # Optional flags.
    flags.DEFINE_string('model_dir', './youtube-8m-models/',
